...
/// 取位置式字段数组并做数量下限校验。
private func fields(_ object: XPCObject, minimum count: Int) throws(XPCMarshalError) -> [XPCObject] {
...
extension RimeSchemaListItem: XPCMarshal {
  ...
  public static func unmarshal(from object: XPCObject) throws(XPCMarshalError) -> RimeSchemaListItem {
    let f = try fields(object, minimum: 2)
...
extension RimeConfigLocation: XPCMarshal {
  ...
  public static func unmarshal(from object: XPCObject) throws(XPCMarshalError) -> RimeConfigLocation {
...
extension RimeNotificationType: XPCMarshal {
  ...
  public static func unmarshal(from object: XPCObject) throws(XPCMarshalError) -> RimeNotificationType {
    let f = try fields(object, minimum: 1)
    switch try Int.unmarshal(from: f[0]) {
    ...
    default:
      throw XPCMarshalError.unknownEnumCase("RimeNotificationType tag", enumName: "RimeNotificationType")
    }
  }
}
